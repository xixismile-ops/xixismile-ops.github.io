function watermark(settings) {
    ...
    defaultSettings.watermark_x =  maskElement.getBoundingClientRect().left+document.documentElement.scrollLeft;
    //获取页面最大宽度
    var page_width = Math.max(maskElement.scrollWidth,maskElement.clientWidth);

    //获取页面最大高度
    var page_height = Math.max(maskElement.scrollHeight,maskElement.clientHeight)-20;
    //水印数量自适应元素区域尺寸
